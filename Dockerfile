...
# LABEL org.opencontainers.image.authors="nospam+dockerfile@knowledge.net.clojars.knowledge"
# LABEL net.clojars.knowledge.knowledge.scribe="knowledge scribe"
# LABEL io.github.practicalli.team="Practicalli Engineering Team"
# LABEL version="0.1.0-SNAPSHOT"
# LABEL description="knowledge scribe service"
...
WORKDIR /service
COPY --from=builder /build/target/knowledge-scribe-standalone.jar /service/
...
CMD ["java", "-jar", "/service/knowledge-scribe-standalone.jar"]
